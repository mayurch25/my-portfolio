...
export default function Register() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      toast.success("Registration successful! Please login.", { id: registerToast });
      navigate("/login");
    } catch (err) {
      toast.error(
  ...
  return (
    <div className={style.loginContainer}>
      <div className={style.loginBox}>
        <h2 className={style.adminHeading}>Create Account</h2>
        ...
        <button onClick={handleRegister} className={style.loginButton}>
          Register
        </button>
